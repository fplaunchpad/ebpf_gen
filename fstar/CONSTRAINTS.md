...
## Differential results (Phase 2 — to be filled)

TBD: table of {F* Strict, F* Kernel, kernel 6.8} verdicts per example,
including the mode-divergence witnesses `ex_div0_reg` and `ex_shift_reg`
(F*-Kernel/kernel-6.8 accept, F*-Strict reject).
