...
**Pinned ground truth**: RFC 9669 (BPF ISA), Linux kernel 7.0 verifier
behavior (Ubuntu 26.04; kernel 6.8 retained as version-drift data point), Veritas Dafny spec (`repos/veritas/ebpf-dafny-spec/spec.dfy`,
...
## Differential results (Phase 2 — run 2026-07-07; kernel 6.8.0-134 AND kernel 7.0.0-27 (VM `kernel7`, Ubuntu 26.04), identical verdicts on both, root)
